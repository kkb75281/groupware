...
export let getSystemWorktime = async (refresh = false) => {
  ...
  getSystemWorktimeRunning = skapi
    .getRecords({
      table: {
...
export let startWork = async (router?: any) => {
  ...
  if (
    system_worktime.value &&
    system_worktime.value.start &&
    system_worktime.value.start.maxTimestamp
  ) {
...
export let endWork = async (router?: any) => {
  ...
  if (
    system_worktime.value &&
    system_worktime.value.end &&
    system_worktime.value.end.maxTimestamp
  ) {
