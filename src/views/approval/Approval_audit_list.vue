    ...
    .tb-overflow
        table.table#tb-auditList
            ...
            tbody
                ...
                template(v-else)
                    tr(v-for="(audit, index) of filterAuditList" :key="audit.user_id" @click.stop="(e) => showAuditDoc(e, audit)" style="cursor: pointer;" :class="{ 'canceled': audit.isCanceled, 'nohover': audit.isCanceled }" :style="audit.isCanceled ? 'cursor: default; opacity: 0.3;' : 'cursor: pointer;'")
                        //- td 
                        //-     label.checkbox
                        //-         input(type="checkbox" name="checkbox")
                        //-         span.label-checkbox
